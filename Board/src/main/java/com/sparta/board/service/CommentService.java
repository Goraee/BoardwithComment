...
import com.sparta.board.Exception.RequestException;
...
public class CommentService {
    ...
    public CommentDto addComment(CommentDto commentDto, Long id, HttpServletRequest request) {
        ...
        Claims claims;
//        CommentResponseDto commentResponseDto = new CommentResponseDto() 댓글구현상관없음
//        return commentResponseDto; // 이게 빈 메소드 생성 (댓글구현 상관없음)
